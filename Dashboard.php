...
<html>
	<head>
		...
		<title>Sports News | Dashboard</title>
		<meta charset="utf-8">
			...
			<div class="container">
					...
					<div class="collapse navbar-collapse" id="navbarCollapseCms">
						...
						<ul class="navbar-nav">
							...
							<li class="nav-item">
								<a href="comment.php" class="nav-link" style="color: white;">Comments</a>
							</li>
						</ul>
		...
		<header class="py-2">
			...
			<div class="container">
				<div class="row">
					...
					<!-- Area to display site stattistics -->
						...
						<div class="card text-center mb-2">
							<div class="card-body">
								...
								<?php
									...
									$stmt = $conn->query($sql);
									$count = $stmt->fetch();
									//Convert entire query result from array to string
									$total = array_shift($count);
									echo $total;
								 ?>
							</div>
						</div>
						<div class="card text-center py-3 mb-2">
							<div class="card-body">
								<h2>Categories</h2>
								<i class="far fa-eye"></i>
								<?php
					...
					<!-- Main display area of dashboard -->
							...
							<?php
							 ...
							 <tbody>
							 	<tr>
							 		...
							 		<td class="text-center"><?php echo $postName; ?></td>
							 		<td class="text-center"><?php echo $postDate; ?></td>
							 		<td class="text-center"><?php echo $postAuthor; ?></td>
							 	</tr>
							 </tbody>
							<?php } ?>
						</table>
						<h1 class="text-center">Most Recently Added</h1>
						<table class="table table-bordered table-hover">
							<tr class="table-head table-primary">
								<th class="text-center">S.No.</th>
								<th class="text-center">Name</th>
